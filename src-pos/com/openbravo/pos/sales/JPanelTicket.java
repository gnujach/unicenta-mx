...
//modificado para agregar precio mayoreo 
    private void addTicketLine(ProductInfoExt oProduct, double dMul, double dPrice) {   
        ...
        else if (!m_oTicket.printCustomerMayoreo())
            addTicketLine(new TicketLineInfo(oProduct, dMul, dPrice, tax, (java.util.Properties) (oProduct.getProperties().clone())));
        else {
            
            dPrice = oProduct.getPriceSell1();
            addTicketLine(new TicketLineInfo(oProduct, dMul, dPrice, tax, (java.util.Properties) (oProduct.getProperties().clone())));
        }
        ...
        if (m_App.getAppUserView().getUser().hasPermission("sales.Total")) {  
            ...
            try {
                ...
                if (executeEvent(ticket, ticketext, "ticket.total") == null) {
                    ...
                    //Mando default setPrintSelected a falso para que no imprima el ticket por default
                    //24/10/13
                    paymentdialog.setPrintSelected(false);
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        jButton1.getAccessibleContext().setAccessibleDescription("Agregar  Cliente");
        ...
        btnSplit.getAccessibleContext().setAccessibleDescription("Cortar Venta");
        ...
        m_jbtnScale.setToolTipText("Báscula");
        m_jbtnScale.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        m_jTotalEuros.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
