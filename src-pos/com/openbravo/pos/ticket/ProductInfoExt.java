...
// ADDED JG 13 Nov 12 - Display
            ...
            product.m_jMarca = dr.getString(17);
            product.m_dPriceSell1 = dr.getDouble(18).doubleValue();
            return product;
        }};
    }
    ...
    /**
     * @param m_dPriceSell1 the m_dPriceSell1 to set
     */
    public void setPriceSell1(double m_dPriceSell1) {
        this.m_dPriceSell1 = m_dPriceSell1;
    }
}
