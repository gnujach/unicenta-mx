...
public class AppConfig implements AppProperties {
    ...
    private File getDefaultConfig() {
        ...
        return new File(new File(System.getProperty("user.home")), AppLocal.APP_ID + ".propertiesDevelop");
    }
...
//        m_propsconfig.setProperty("db.password", "");
        ...
        m_propsconfig.setProperty("db.driverlib", "lib/mysql-connector-java-5.1.15-bin.jar");
        m_propsconfig.setProperty("db.driver", "com.mysql.jdbc.Driver");        
        m_propsconfig.setProperty("db.URL", "jdbc:mysql://localhost:3306/adminpos");
