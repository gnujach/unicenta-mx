...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Rol de Admon', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Rol de Gestion', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Rol de Empleado', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Rol de Invitado', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('1', 'mon5', 1, $FILE{/com/openbravo/pos/templates/mon50.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('2', 'mon1', 1, $FILE{/com/openbravo/pos/templates/mon1.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('3', 'mon2', 1, $FILE{/com/openbravo/pos/templates/mon2.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('4', 'mon50', 1, $FILE{/com/openbravo/pos/templates/mon5.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('5', 'mon10', 1, $FILE{/com/openbravo/pos/templates/mon10.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('6', 'mon20', 1, $FILE{/com/openbravo/pos/templates/mon20.jpg});
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('60', 'img.user', 1, $FILE{/com/openbravo/pos/templates/img.user.png});


INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('19', 'billete1000', 1, $FILE{/com/openbravo/pos/templates/billete1000.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('20', 'billete500', 1, $FILE{/com/openbravo/pos/templates/billete500.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('21', 'billete200', 1, $FILE{/com/openbravo/pos/templates/billete200.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('22', 'billete100', 1, $FILE{/com/openbravo/pos/templates/billete100.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('23', 'billete50', 1, $FILE{/com/openbravo/pos/templates/billete50.jpg});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('24', 'billete20', 1, $FILE{/com/openbravo/pos/templates/billete20.jpg});

INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('25', 'payment.cash', 0, $FILE{/com/openbravo/pos/templates/payment.cash.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('26', 'Printer.CloseCash', 0, $FILE{/com/openbravo/pos/templates/Printer.CloseCash.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('27', 'Printer.CustomerPaid', 0, $FILE{/com/openbravo/pos/templates/Printer.CustomerPaid.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('28', 'Printer.CustomerPaid2', 0, $FILE{/com/openbravo/pos/templates/Printer.CustomerPaid2.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('29', 'Printer.FiscalTicket', 0, $FILE{/com/openbravo/pos/templates/Printer.FiscalTicket.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('30', 'Printer.Inventory', 0, $FILE{/com/openbravo/pos/templates/Printer.Inventory.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('31', 'Printer.OpenDrawer', 0, $FILE{/com/openbravo/pos/templates/Printer.OpenDrawer.xml});
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('42', 'script.Event.Total', 0, $FILE{/com/openbravo/pos/templates/script.Event.Total.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('43', 'script.linediscount', 0, $FILE{/com/openbravo/pos/templates/script.linediscount.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('44', 'script.ReceiptConsolidate', 0, $FILE{/com/openbravo/pos/templates/script.ReceiptConsolidate.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('45', 'script.Refundit', 0, $FILE{/com/openbravo/pos/templates/script.Refundit.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('46', 'script.SendOrder', 0, $FILE{/com/openbravo/pos/templates/script.SendOrder.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('47', 'script.SetPerson', 0, $FILE{/com/openbravo/pos/templates/script.SetPerson.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('48', 'script.StockCurrentAdd', 0, $FILE{/com/openbravo/pos/templates/script.StockCurrentAdd.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('49', 'script.StockCurrentSet', 0, $FILE{/com/openbravo/pos/templates/script.StockCurrentSet.txt});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('50', 'script.totaldiscount', 0, $FILE{/com/openbravo/pos/templates/script.totaldiscount.txt});

INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('51', 'Ticket.Buttons', 0, $FILE{/com/openbravo/pos/templates/Ticket.Buttons.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('52', 'Ticket.Close', 0, $FILE{/com/openbravo/pos/templates/Ticket.Close.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('53', 'Ticket.Discount', 0, $FILE{/com/openbravo/pos/templates/Ticket.Discount.xml});
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('54', 'Ticket.Line', 0, $FILE{/com/openbravo/pos/templates/Ticket.Line.xml});

INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('55', 'Window.Logo', 1, $FILE{/com/openbravo/pos/templates/Window.Logo.png});
...
CREATE TABLE CUSTOMERS (
    ...
    CURDATE DATETIME,
    CURDEBT DOUBLE,
    MAYOREO BIT DEFAULT b'0' NOT NULL,
    PRIMARY KEY (ID),    
...
INSERT INTO CUSTOMERS(ID, SEARCHKEY,NAME, MAYOREO) VALUES ('001','MOSTRADOR','C. MOSTRADOR',0);
INSERT INTO CUSTOMERS(ID, SEARCHKEY,NAME, MAYOREO) VALUES ('002','MAYOREO','C. MAYOREO',1);
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', 'Categoría General');
...
CREATE UNIQUE INDEX MARCAS_NAME_INX ON MARCAS(NAME);
INSERT INTO MARCAS (ID,NAME) VALUES('001','GENERAL');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'Sin Impuesto');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Sin Impuesto', '000', NULL, NULL, 0, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'IVA', '001', NULL, NULL, 0.16, FALSE, NULL);
...
CREATE TABLE PRODUCTS (
    ...
    CONSTRAINT PRODUCTS_FK_2 FOREIGN KEY (MARCA) REFERENCES MARCAS(ID),
...
CREATE TABLE RESERVATIONS (
    ...
    DATENEW DATETIME DEFAULT '2014-01-01 00:00:00' NOT NULL,
...
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('0', 'Almuerzo Break', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('1', 'Refregerio Break', TRUE, NULL);
INSERT INTO BREAKS(ID, NAME, VISIBLE, NOTES) VALUES ('2', 'Break', TRUE, NULL);
